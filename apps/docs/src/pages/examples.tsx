...
export default function ExamplesPage() {
  ...
  return (
    ...
    >
      <main className="min-h-screen bg-surface-alt [color-scheme:light] dark:[color-scheme:dark]">
        {/* Header */}
        <section className="relative overflow-hidden border-b border-slate-900/[0.08] dark:border-white/[0.06]">
          ...
          <div className="max-w-6xl mx-auto px-5 pt-16 pb-10 text-center">
            ...
            <motion.p
              className="max-w-xl mx-auto text-base leading-[1.7] text-slate-600 dark:text-slate-100/50 font-sans"
